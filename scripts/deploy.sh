...
scp -i ~/.ssh/epimorphism.pem html/lib/* ubuntu@52.40.74.208:/home/ubuntu/www/epimorphism/lib
...
#scp -i ~/.ssh/epimorphism.pem -r html/textures* ubuntu@52.40.74.208:/home/ubuntu/www/epimorphism/textures
