...
var EngineConfD = (function () {
    function EngineConfD(value0) {
        this.value0 = value0;
    };
    EngineConfD.create = function (value0) {
        return new EngineConfD(value0);
    };
    return EngineConfD;
})();
var Shiz = function (shiz) {
    this.shiz = shiz;
};
var unpackEngineConf = function (v) {
    return v.value0;
};
var tmp = new Shiz(function (v) {
    return "asdf";
});
var showEngineConfD = new Prelude.Show(function (v) {
    return "{ name: " + (Prelude.show(Prelude.showString)(v.value0.name) + (", kernelDim: " + (Prelude.show(Prelude.showInt)(v.value0.kernelDim) + (", fract: " + (Prelude.show(Prelude.showInt)(v.value0.fract) + " }")))));
});
var shiz = function (dict) {
    return dict.shiz;
};
var engineConfDIsForeign = new Data_Foreign_Class.IsForeign(function (value) {
    return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.stringIsForeign)(Data_Foreign_Index.indexString)("name")(value))(function (v) {
        return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.intIsForeign)(Data_Foreign_Index.indexString)("kernelDim")(value))(function (v1) {
            return Prelude.bind(Data_Either.bindEither)(Data_Foreign_Class.readProp(Data_Foreign_Class.intIsForeign)(Data_Foreign_Index.indexString)("fract")(value))(function (v2) {
                return Prelude["return"](Data_Either.applicativeEither)(new EngineConfD({
                    name: v, 
                    kernelDim: v1, 
                    fract: v2
                }));
...
module.exports = {
    ...
    EngineConfD: EngineConfD, 
    Shiz: Shiz, 
    shiz: shiz, 
    unpackEngineConf: unpackEngineConf, 
    showEngineConfD: showEngineConfD, 
    engineConfDIsForeign: engineConfDIsForeign, 
    tmp: tmp
};

},{"Control.Monad.Eff":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff/index.js","Control.Monad.Except.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Except.Trans/index.js","DOM":"/Users/gene/Programming/pure_morph/output/DOM/index.js","Data.Either":"/Users/gene/Programming/pure_morph/output/Data.Either/index.js","Data.Foreign":"/Users/gene/Programming/pure_morph/output/Data.Foreign/index.js","Data.Foreign.Class":"/Users/gene/Programming/pure_morph/output/Data.Foreign.Class/index.js","Data.Foreign.Index":"/Users/gene/Programming/pure_morph/output/Data.Foreign.Index/index.js","Data.Maybe":"/Users/gene/Programming/pure_morph/output/Data.Maybe/index.js","Data.StrMap":"/Users/gene/Programming/pure_morph/output/Data.StrMap/index.js","Data.Tuple":"/Users/gene/Programming/pure_morph/output/Data.Tuple/index.js","Graphics.Canvas":"/Users/gene/Programming/pure_morph/output/Graphics.Canvas/index.js","Graphics.WebGL.Types":"/Users/gene/Programming/pure_morph/output/Graphics.WebGL.Types/index.js","Prelude":"/Users/gene/Programming/pure_morph/output/Prelude/index.js"}],"/Users/gene/Programming/pure_morph/output/Control.Alt/index.js":[function(require,module,exports){
// Generated by psc version 0.8.0.0
"use strict";
var Prelude = require("Prelude");
            ...
            return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Eff_Class.monadEffEff))(Graphics_Canvas.getCanvasElementById(canvasId)))(function (v) {
                if (v instanceof Data_Maybe.Just) {
                    return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Eff_Class.monadEffEff))(Graphics_WebGL_Context.getWebglContext(v.value0)))(function (v1) {
                        ...
                        throw new Error("Failed pattern match at Engine line 89, column 1 - line 90, column 1: " + [ v1.constructor.name ]);
                    });
                };
                throw new Error("Failed pattern match at Engine line 89, column 1 - line 90, column 1: " + [ v.constructor.name ]);
            });
        };
    };
};
            ...
            return function (frameNum) {
                return execGL(engineST.ctx)((function () {
                    var tm = (function () {
                        ...
                        throw new Error("Failed pattern match at Engine line 121, column 9 - line 122, column 5: " + [ $51.constructor.name ]);
                    })();
                    var td = (function () {
                        var $52 = frameNum % 2 === 1;
                        if ($52) {
                        ...
                        throw new Error("Failed pattern match at Engine line 122, column 9 - line 123, column 5: " + [ $52.constructor.name ]);
                    })();
                    var fb = (function () {
                        var $53 = frameNum % 2 === 1;
                        if ($53) {
                        ...
                        throw new Error("Failed pattern match at Engine line 123, column 9 - line 126, column 5: " + [ $53.constructor.name ]);
                    })();
...
var initSystemST = function (systemConf) {
    var handle = function (f) {
        return function (v) {
            if (v instanceof Data_Either.Left) {
                return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Eff.monadEff))(Prelude.show(Data_Foreign.showForeignError)(v.value0));
            };
            if (v instanceof Data_Either.Right) {
                return Prelude["return"](Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Eff.applicativeEff))(Prelude.map(Prelude.functorArray)(f)(v.value0));
            };
            throw new Error("Failed pattern match at System line 60, column 5 - line 61, column 5: " + [ f.constructor.name, v.constructor.name ]);
        };
    };
    return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Prelude["<$>"](Control_Monad_Except_Trans.functorExceptT(Control_Monad_Eff.functorEff))(Data_Foreign_Class.readJSON(Data_Foreign_Class.arrayIsForeign(Config.engineConfDIsForeign)))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(JSUtil.unsafeURLGet("/lib/engine_conf.json"))))(function (v) {
        return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(handle(Config.unpackEngineConf)(v))(function (v1) {
            var st$prime = (function () {
                var $9 = {};
                for (var $10 in defaultSystemST) {
                    if (defaultSystemST.hasOwnProperty($10)) {
                        $9[$10] = defaultSystemST[$10];
                    };
                };
                $9.engineConfLib = v1;
                return $9;
            })();
            return Prelude["return"](Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Eff.applicativeEff))(st$prime);
        });
    });
};
...
},{"Config":"/Users/gene/Programming/pure_morph/output/Config/index.js","Control.Monad.Eff":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff/index.js","Control.Monad.Error.Class":"/Users/gene/Programming/pure_morph/output/Control.Monad.Error.Class/index.js","Control.Monad.Except.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Except.Trans/index.js","Control.Monad.ST":"/Users/gene/Programming/pure_morph/output/Control.Monad.ST/index.js","Control.Monad.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Trans/index.js","Data.Array":"/Users/gene/Programming/pure_morph/output/Data.Array/index.js","Data.Either":"/Users/gene/Programming/pure_morph/output/Data.Either/index.js","Data.Foreign":"/Users/gene/Programming/pure_morph/output/Data.Foreign/index.js","Data.Foreign.Class":"/Users/gene/Programming/pure_morph/output/Data.Foreign.Class/index.js","Data.Maybe":"/Users/gene/Programming/pure_morph/output/Data.Maybe/index.js","Data.StrMap":"/Users/gene/Programming/pure_morph/output/Data.StrMap/index.js","Data.String":"/Users/gene/Programming/pure_morph/output/Data.String/index.js","Data.Traversable":"/Users/gene/Programming/pure_morph/output/Data.Traversable/index.js","Data.Tuple":"/Users/gene/Programming/pure_morph/output/Data.Tuple/index.js","JSUtil":"/Users/gene/Programming/pure_morph/output/JSUtil/index.js","Prelude":"/Users/gene/Programming/pure_morph/output/Prelude/index.js"}],"/Users/gene/Programming/pure_morph/output/UI/foreign.js":[function(require,module,exports){
"use strict";
