                ...
                return function (pRef) {
                    return function (msg) {
                        return function __do() {
                            var v = Control_Monad_ST.readSTRef(scRef)();
...
},{"Control.Monad.Eff":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff/index.js","Data.Maybe":"/Users/gene/Programming/pure_morph/output/Data.Maybe/index.js","Data.StrMap":"/Users/gene/Programming/pure_morph/output/Data.StrMap/index.js","Data.Tuple":"/Users/gene/Programming/pure_morph/output/Data.Tuple/index.js","Graphics.WebGL.Types":"/Users/gene/Programming/pure_morph/output/Graphics.WebGL.Types/index.js"}],"/Users/gene/Programming/pure_morph/output/Control.Alt/index.js":[function(require,module,exports){
// Generated by psc version 0.8.0.0
"use strict";
var Prelude = require("Prelude");
...
var execGL = function (ctx) {
    return function (webGL) {
        return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Graphics_WebGL.runWebgl(webGL)(ctx)))(function (v) {
            ...
            throw new Error("Failed pattern match at Engine line 147, column 1 - line 148, column 1: " + [ v.constructor.name ]);
        });
    };
};
            ...
            return function (frameNum) {
                return execGL(engineState.ctx)((function () {
                    var tm = (function () {
                        ...
                        throw new Error("Failed pattern match at Engine line 121, column 9 - line 122, column 5: " + [ $53.constructor.name ]);
                    })();
                    var td = (function () {
                        var $54 = frameNum % 2 === 1;
                        if ($54) {
                        ...
                        throw new Error("Failed pattern match at Engine line 122, column 9 - line 123, column 5: " + [ $54.constructor.name ]);
                    })();
                    var fb = (function () {
                        var $55 = frameNum % 2 === 1;
                        if ($55) {
                        ...
                        throw new Error("Failed pattern match at Engine line 123, column 9 - line 126, column 5: " + [ $55.constructor.name ]);
                    })();
...
var main = function __do() {
    ...
    throw new Error("Failed pattern match at Main line 25, column 1 - line 26, column 1: " + [ v.constructor.name ]);
};
module.exports = {
    animate: animate, 
    doMain: doMain, 
...
},{"Config":"/Users/gene/Programming/pure_morph/output/Config/index.js","Data.Maybe":"/Users/gene/Programming/pure_morph/output/Data.Maybe/index.js","Prelude":"/Users/gene/Programming/pure_morph/output/Prelude/index.js"}],"/Users/gene/Programming/pure_morph/output/UI/foreign.js":[function(require,module,exports){
"use strict";
                        ...
                        return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Data_DOM_Simple_Element.setStyleAttr(Data_DOM_Simple_Element.htmlElement)("width")(Prelude.show(Prelude.showNumber)(v2 - 10.0) + "px")(v3.value0)))(function () {
                            return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Data_DOM_Simple_Element.setStyleAttr(Data_DOM_Simple_Element.htmlElement)("height")(Prelude.show(Prelude.showNumber)(v2 - 11.0) + "px")(v3.value0)))(function () {
                                return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Data_DOM_Simple_Element.querySelector(Data_DOM_Simple_Document.htmlDocumentElement)("#" + uiConf.consoleId)(v)))(function (v4) {
                                    ...
                                    throw new Error("Failed pattern match at UI line 48, column 1 - line 49, column 1: " + [ v4.constructor.name ]);
                                });
                            });
                        });
                    };
                    throw new Error("Failed pattern match at UI line 48, column 1 - line 49, column 1: " + [ v3.constructor.name ]);
                });
            });
        });
    });
                ...
                return function (pRef) {
                    return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Control_Monad_ST.readSTRef(ucRef)))(function (v) {
                        return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(initLayout(v))(function () {
                            return Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)($foreign.registerEventHandler(Command.command(ucRef)(scRef)(ecRef)(esRef)(pRef)));
                        });
                    });
                };
            };
...
},{"./foreign":"/Users/gene/Programming/pure_morph/output/UI/foreign.js","Command":"/Users/gene/Programming/pure_morph/output/Command/index.js","Config":"/Users/gene/Programming/pure_morph/output/Config/index.js","Control.Monad.Eff":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff/index.js","Control.Monad.Eff.Class":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff.Class/index.js","Control.Monad.Eff.Console":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff.Console/index.js","Control.Monad.Error.Class":"/Users/gene/Programming/pure_morph/output/Control.Monad.Error.Class/index.js","Control.Monad.Except.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Except.Trans/index.js","Control.Monad.ST":"/Users/gene/Programming/pure_morph/output/Control.Monad.ST/index.js","Control.Monad.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Trans/index.js","DOM":"/Users/gene/Programming/pure_morph/output/DOM/index.js","Data.DOM.Simple.Document":"/Users/gene/Programming/pure_morph/output/Data.DOM.Simple.Document/index.js","Data.DOM.Simple.Element":"/Users/gene/Programming/pure_morph/output/Data.DOM.Simple.Element/index.js","Data.DOM.Simple.Window":"/Users/gene/Programming/pure_morph/output/Data.DOM.Simple.Window/index.js","Data.Int":"/Users/gene/Programming/pure_morph/output/Data.Int/index.js","Data.Maybe":"/Users/gene/Programming/pure_morph/output/Data.Maybe/index.js","Graphics.Canvas":"/Users/gene/Programming/pure_morph/output/Graphics.Canvas/index.js","JSUtil":"/Users/gene/Programming/pure_morph/output/JSUtil/index.js","Prelude":"/Users/gene/Programming/pure_morph/output/Prelude/index.js"}],"/Users/gene/Programming/pure_morph/output/Unsafe.Coerce/foreign.js":[function(require,module,exports){
"use strict";
