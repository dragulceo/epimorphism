...
},{"Config":"/Users/gene/Programming/pure_morph/output/Config/index.js","Control.Monad.Eff":"/Users/gene/Programming/pure_morph/output/Control.Monad.Eff/index.js","Control.Monad.Error.Class":"/Users/gene/Programming/pure_morph/output/Control.Monad.Error.Class/index.js","Control.Monad.Except.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Except.Trans/index.js","Control.Monad.Trans":"/Users/gene/Programming/pure_morph/output/Control.Monad.Trans/index.js","JSUtil":"/Users/gene/Programming/pure_morph/output/JSUtil/index.js","Prelude":"/Users/gene/Programming/pure_morph/output/Prelude/index.js"}],"/Users/gene/Programming/pure_morph/output/Config/index.js":[function(require,module,exports){
// Generated by psc version 0.8.0.0
"use strict";
var Prelude = require("Prelude");
        ...
        return function (pattern) {
            return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(Control_Monad_ST.readSTRef(esRef)))(function (v) {
                return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Compiler.compileShaders(pattern)(sys))(function (v1) {
                    return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(execGL(v.ctx)(Prelude.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Eff.monadEff)))(Graphics_WebGL_Shader.compileShadersIntoProgram(v1.vert)(v1.mainFrag))(function (v2) {
                        return Prelude.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Eff.monadEff)))(Graphics_WebGL_Shader.compileShadersIntoProgram(v1.vert)(v1.dispFrag))(function (v3) {
                ...
                if (key === "modules") {
                    return Prelude[">>="](Data_Either.bindEither)(fromLMp("modules")(val))(function (x) {
                        return Prelude["return"](Data_Either.applicativeEither)((function () {
                            ...
                            $78.modules = new Config.SubModuleRef(x);
                            return $78;
                        })());
                    });
                };
...
var loadLib = function (name) {
    return function (lib) {
        ...
        throw new Error("Failed pattern match at System line 67, column 1 - line 68, column 1: " + [ $10.constructor.name ]);
    };
};
var defaultSystemST = {
...
var buildSLib = function (f) {
    return function (loc) {
        return Prelude.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Eff.monadEff))(Control_Monad_Trans.lift(Control_Monad_Except_Trans.monadTransExceptT)(Control_Monad_Eff.monadEff)(JSUtil.unsafeURLGet(loc)))(function (v) {
            ...
            throw new Error("Failed pattern match at System line 75, column 1 - line 76, column 1: " + [ $13.constructor.name ]);
        });
    };
};
